...
def get_all_recommendations_for_user(similarity_series):
    # Return all books, sorted by similarity
    all_books = similarity_series.sort_values(ascending=False)
    return list(all_books.index)
...
def cbf(user_id=None):
    ...
    if user_id is not None:
        ...
        recommendations = get_all_recommendations_for_user(similarity_series)
